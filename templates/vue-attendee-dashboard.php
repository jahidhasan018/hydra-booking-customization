...
$attendee_data = [
    ...
    'allowCancellation' => (bool) get_option( 'hbc_allow_booking_cancellation', true ),
    'allowRescheduling' => (bool) get_option( 'hbc_allow_booking_rescheduling', true ),
    'currentUser' => [
    ...
    'translations' => [
        ...
        'booking_cancelled'        => __( 'Booking cancelled successfully', 'hydra-booking-customization' ),
        'failed_cancel_booking'    => __( 'Failed to cancel booking', 'hydra-booking-customization' ),
        'link_copied'              => __( 'Link copied to clipboard', 'hydra-booking-customization' ),
        'reschedule'               => __( 'Reschedule', 'hydra-booking-customization' ),
